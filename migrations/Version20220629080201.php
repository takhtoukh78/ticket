 ...
 */
final class Version20220629080201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE Id_panel Id_panneaux INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA36F731F77 FOREIGN KEY (Id_panneaux) REFERENCES panneaux (id_pa)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_97A0ADA36F731F77 ON ticket (Id_panneaux)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY FK_97A0ADA36F731F77');
        $this->addSql('DROP INDEX UNIQ_97A0ADA36F731F77 ON ticket');
        $this->addSql('ALTER TABLE ticket CHANGE Id_panneaux Id_panel INT DEFAULT NULL');
