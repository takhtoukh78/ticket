 ...
 */
final class Version20220628145912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_conversation ADD CONSTRAINT FK_4A58DA422378417E FOREIGN KEY (nom_pa) REFERENCES panneaux (nom_pa)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4A58DA422378417E ON ticket_conversation (nom_pa)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_conversation DROP FOREIGN KEY FK_4A58DA422378417E');
        $this->addSql('DROP INDEX UNIQ_4A58DA422378417E ON ticket_conversation');
        $this->addSql('DROP INDEX UNIQ_4A58DA42B55EF069 ON ticket_conversation');
        $this->addSql('DROP INDEX UNIQ_4A58DA4234CA9FDB ON ticket_conversation');
        $this->addSql('DROP INDEX UNIQ_4A58DA42121F7504 ON ticket_conversation');
        $this->addSql('DROP INDEX UNIQ_4A58DA42896AA038 ON ticket_conversation');
