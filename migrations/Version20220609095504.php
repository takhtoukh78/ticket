 ...
 */
final class Version20220609095504 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket_conversation (id INT AUTO_INCREMENT NOT NULL, id_contact INT DEFAULT NULL, id_ticket INT DEFAULT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, state VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, priority VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, date_creation DATE NOT NULL, id_Panel INT DEFAULT NULL, UNIQUE INDEX UNIQ_4A58DA4292FF4F48 (id_contact), UNIQUE INDEX UNIQ_4A58DA428DE9BD3B (id_Panel), UNIQUE INDEX UNIQ_4A58DA42B197184E (id_ticket), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
